@automaticScroll
#  CONFIG=./configs/automaticscroll/automaticscroll_local_config.properties PLATFORM=android TAG=automaticScroll ./gradlew run
Feature: Automatic scroll app test

  #  CONFIG=./configs/automaticscroll/automaticscroll_local_config.properties PLATFORM=android TAG=scrollInDynamicLayer ./gradlew run
