...
#  CONFIG=./configs/dineout_local_config.properties PLATFORM=android TAG=dineout ./gradlew run
#  CONFIG=./configs/dineout_local_config.properties PLATFORM=web TAG=dineout ./gradlew run
