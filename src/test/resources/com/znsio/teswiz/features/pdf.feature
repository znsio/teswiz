...
Feature: PDF validation using Applitools
  ...
  #  RUN_IN_CI=true CONFIG=./configs/pdf/pdf_web_browserstack_config.properties CLOUD_USERNAME=$BROWSERSTACK_CLOUD_USERNAME CLOUD_KEY=$BROWSERSTACK_CLOUD_KEY PLATFORM=web TAG="@validatePDF and @browserstack" ./gradlew run
  #  RUN_IN_CI=true CONFIG=./configs/pdf/pdf_android_browserstack_config.properties CLOUD_USERNAME=$BROWSERSTACK_CLOUD_USERNAME CLOUD_KEY=$BROWSERSTACK_CLOUD_KEY PLATFORM=web TAG="@validatePDF and @browserstack" ./gradlew run
