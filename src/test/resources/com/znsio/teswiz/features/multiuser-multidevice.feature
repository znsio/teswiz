...
#  CONFIG=./configs/calculator/calculator2_local_config.properties TAG="@multidevice and @multiuser-android and @calculator" ./gradlew run
...
#  CONFIG=./configs/calculator/calculator_local_config.properties TAG="@multidevice and @multiuser-android and @calculator-theapp" ./gradlew run
...
#  CONFIG=./configs/calculator/calculator_local_config.properties TAG="@multidevice and @multiuser-web" ./gradlew run
  @multiuser-web
...
#  CONFIG=./configs/calculator/calculator_local_config.properties TAG="@multidevice and @multiuser-android-web" ./gradlew run
