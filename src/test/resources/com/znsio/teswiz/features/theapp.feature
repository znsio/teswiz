...
#  RUN_IN_CI=true CONFIG=./configs/theapp/theapp_headspin_config.properties CLOUD_KEY=$HEADSPIN_CLOUD_KEY PLATFORM=android TAG="@theapp and @invalidLogin1 and @headspin" ./gradlew run
