@ajio @prod @guestUser
Feature: Ajio tests
#  CONFIG=./configs/ajio_local_android_config.properties TAG="@ajio and @imagesearch" PLATFORM=android ./gradlew run
#  CONFIG=./configs/ajio_local_ios_config.properties TAG="@ajio and @imagesearch" PLATFORM=iOS ./gradlew run
...
# CONFIG=./configs/ajio_local_android_config.properties TAG=@flick PLATFORM=android ./gradlew run
  @android @flick
