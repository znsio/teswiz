...
class PlaywrightCloudSessionMetadataResolverTest {
    private final PlaywrightCloudSessionMetadataResolver resolver = new PlaywrightCloudSessionMetadataResolver();
