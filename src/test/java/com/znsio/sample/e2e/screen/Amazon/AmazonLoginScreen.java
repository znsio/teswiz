...
import com.znsio.sample.e2e.screen.web.Amazon.AmazonLoginScreenWeb;
...
public abstract class AmazonLoginScreen {
    ...
    public abstract AmazonHomeScreen loginWithCredentials(String userName, String password);
}
