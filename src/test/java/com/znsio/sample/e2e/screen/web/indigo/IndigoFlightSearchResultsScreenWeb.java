...
public class IndigoFlightSearchResultsScreenWeb
    ...
    private static final String SCREEN_NAME = IndigoFlightSearchResultsScreenWeb.class.getSimpleName();
    private static final Logger LOGGER = Logger.getLogger(SCREEN_NAME);
    private static final String NOT_YET_IMPLEMENTED = " not yet implemented";
    private static final By byBackToSearchResultsLinkXpath = By.xpath("//div[@class='bck-to-search']");
