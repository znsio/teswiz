...
public class IndigoGiftVouchersScreenAndroid
    ...
    private static final By bySelectDenominationDropdownXpath = By.xpath("//android.widget.TextView[@text='Select Denomination']");
    private static final String bySelectValueFromDropdown = "//android.widget.CheckedTextView[@text='%s']";
    private static final By bySelectQuantityDropdownXpath = By.xpath("//android.widget.TextView[@text='Select']");
    private static final By byPreviewButtonXpath = By.xpath("//android.widget.Button[@text='Preview']");
    private static final By byTotalAmountId = By.id("in.goindigo.android:id/lblTotal");

    private static final String byGiftValueTitleXpath = "//android.widget.TextView[@text='Gift Voucher Denomination']";
    ...
    public IndigoGiftVouchersScreen select(String numberOfGiftVouchersToPurchase, String denomination, String forWhom, String customMessage) {
        driver.findElement(bySelectDenominationDropdownXpath)
              .click();
        String denominationToSelectXpath = String.format(bySelectValueFromDropdown, denomination);
        driver.waitTillElementIsVisible(By.xpath(denominationToSelectXpath))
              .click();
        visually.checkWindow(SCREEN_NAME, "Selected voucher denomination");
        driver.waitTillElementIsVisible(bySelectQuantityDropdownXpath)
              .click();
        String quantitytoSelectXpath = String.format(bySelectValueFromDropdown, numberOfGiftVouchersToPurchase);
        driver.waitTillElementIsVisible(By.xpath(quantitytoSelectXpath))
              .click();
        ...
        String lblTotal = driver.findElement(byTotalAmountId)
                                .getText();
