...
import static com.znsio.teswiz.runner.atd.FileLocations.SERVER_CONFIG_JSON;
...
public class ATDRunner {
    ...
    public ATDRunner() throws Exception {
        ...
        FileUtils.createParentDirectory(getProperty(USER_DIR), FileLocations.OUTPUT_DIRECTORY);
    }
    ...
    private void writeServiceConfig() {
        ...
        try (FileWriter writer = new FileWriter(new File(getProperty("user.dir") + SERVER_CONFIG_JSON))) {
