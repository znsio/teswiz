...
//        String scenarioLogDirectory = FileLocations.REPORTS_DIRECTORY + scenarioRunCount + "-" + normalisedScenarioName + File.separator;
//
//        testExecutionContext.addTestState(TEST_CONTEXT.EXAMPLE_RUN_COUNT, scenarioRunCount);
...
//        testExecutionContext.addTestState(TEST_CONTEXT.SCREENSHOT_DIRECTORY, scenarioLogDirectory + "screenshot" + File.separator);
//    }
//
