...
If you need to pass proxy information to the docker container, the [dockerContainers.sh](../../dockerContainers.sh) file will automatically use [docker-compose-proxy-v3.yml](../../docker-compose-v3-proxy.yml) to start/stop the containers.
