...
1. For `web` automation
   ...
   * Set `WEB_ENGINE=selenium` in config.properties by default, and switch to the Playwright engine you want when you are ready to exercise the same flow with Playwright
